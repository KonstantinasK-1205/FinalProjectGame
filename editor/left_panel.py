...
class LeftPanel(gui.VBox):
    ...
    def init_entities(self):
        items = [
            ...
            ("entity:S", "Pistol Ammo", "resources/sprites/pickups/ammo/pistol.png"),
            ("entity:D", "Shotgun Ammo", "resources/sprites/pickups/ammo/shotgun.png"),
            ("entity:F", "Rifle Ammo", "resources/sprites/pickups/ammo/rifle.png"),
